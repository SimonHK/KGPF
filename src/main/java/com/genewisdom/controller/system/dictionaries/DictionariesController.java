package com.genewisdom.controller.system.dictionaries;
...
import com.genewisdom.service.system.dictionaries.DictionariesManager;
...
public class DictionariesController extends BaseController {
	...
	public ModelAndView listAllDict(Model model,String DICTIONARIES_ID)throws Exception{
		...
		pd = this.getPageData();
		try{
			String json = JSONArray.toJSONString(dictionariesService.listAllDict("0"));
