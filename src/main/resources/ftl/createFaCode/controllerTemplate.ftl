package com.genewisdom.controller.${packageName}.${objectNameLower};
...
import com.genewisdom.service.${packageName}.${objectNameLower}.${objectName}Manager;
import com.genewisdom.service.${packageName}.${objectNameLower}mx.${objectName}MxManager;
